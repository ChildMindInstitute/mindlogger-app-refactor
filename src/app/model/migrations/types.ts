...
import { RootStateTo as RootState0003 } from './migrations/to0003/MigrationToVersion0003.ts';

type FlowState = FlowState0000 | FlowState0001;

export type ReduxRootState = RootState0000 | RootState0001 | RootState0003;
